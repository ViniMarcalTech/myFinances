...
import com.myfinances.resources.model.request.IncomeRequest;
import com.myfinances.resources.model.response.IncomeResponse;
import com.myfinances.services.IncomeService;
...
public class IncomeController {
    ...
    public ResponseEntity<List<IncomeResponse>> findAll() {
        ...
        return ResponseEntity.ok().body( service.findAll()
                .stream()
                .map(dto -> new ModelMapper().map(dto,IncomeResponse.class))
